    ...
    return (
        <div>
            <div className='flex justify-between py-8 px-16'>
                <NavLink to="/education" className="py-3 px-8 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600">Back</NavLink>
                <NavLink to="/work" className="py-3 px-8 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600">Next</NavLink>
            </div>
            <div className="w-full px-32 py-4">
                <h1 className="text-5xl text-blue-400 font-bold mb-6 text-center">Skills</h1>
